# Comparing `tmp/goatl-0.6.3.tar.gz` & `tmp/goatl-0.6.4.tar.gz`
...
## Comparing `goatl-0.6.3.tar` & `goatl-0.6.4.tar`
...
### Comparing `goatl-0.6.3/LICENSE` & `goatl-0.6.4/LICENSE`

 * *Files identical despite different names*

### Comparing `goatl-0.6.3/pyproject.toml` & `goatl-0.6.4/pyproject.toml`
...
### Comparing `goatl-0.6.3/README.md` & `goatl-0.6.4/README.md`

 * *Files identical despite different names*

### Comparing `goatl-0.6.3/src/goatl/core.py` & `goatl-0.6.4/src/goatl/core.py`
...
### Comparing `goatl-0.6.3/src/goatl/utils.py` & `goatl-0.6.4/src/goatl/utils.py`

 * *Files identical despite different names*

### Comparing `goatl-0.6.3/setup.py` & `goatl-0.6.4/setup.py`
...
### Comparing `goatl-0.6.3/PKG-INFO` & `goatl-0.6.4/PKG-INFO`
