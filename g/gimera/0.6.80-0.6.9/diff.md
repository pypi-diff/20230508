# Comparing `tmp/gimera-0.6.80.tar.gz` & `tmp/gimera-0.6.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gimera-0.6.80.tar", last modified: Mon May  8 17:42:52 2023, max compression
+gzip compressed data, was "gimera-0.6.9.tar", last modified: Fri Jul  8 21:48:00 2022, max compression
```

## Comparing `gimera-0.6.80.tar` & `gimera-0.6.9.tar`

### file list

```diff
@@ -1,21 +1,19 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-08 17:42:52.282132 gimera-0.6.80/
--rw-r--r--   0 runner    (1001) docker     (123)     1068 2023-05-08 17:41:58.000000 gimera-0.6.80/LICENSE.txt
--rw-r--r--   0 runner    (1001) docker     (123)     3875 2023-05-08 17:42:52.282132 gimera-0.6.80/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     3555 2023-05-08 17:41:58.000000 gimera-0.6.80/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-08 17:42:52.282132 gimera-0.6.80/gimera/
--rw-r--r--   0 runner    (1001) docker     (123)      122 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    10192 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/config.py
--rw-r--r--   0 runner    (1001) docker     (123)      174 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/consts.py
--rwxr-xr-x   0 runner    (1001) docker     (123)    36666 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/gimera.py
--rw-r--r--   0 runner    (1001) docker     (123)     4113 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/gitcommands.py
--rw-r--r--   0 runner    (1001) docker     (123)    12789 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/repo.py
--rw-r--r--   0 runner    (1001) docker     (123)     3205 2023-05-08 17:41:58.000000 gimera-0.6.80/gimera/tools.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-05-08 17:42:52.282132 gimera-0.6.80/gimera.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     3875 2023-05-08 17:42:52.000000 gimera-0.6.80/gimera.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      345 2023-05-08 17:42:52.000000 gimera-0.6.80/gimera.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-05-08 17:42:52.000000 gimera-0.6.80/gimera.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       45 2023-05-08 17:42:52.000000 gimera-0.6.80/gimera.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       36 2023-05-08 17:42:52.000000 gimera-0.6.80/gimera.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        7 2023-05-08 17:42:52.000000 gimera-0.6.80/gimera.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      397 2023-05-08 17:42:52.282132 gimera-0.6.80/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1701 2023-05-08 17:41:58.000000 gimera-0.6.80/setup.py
...
### Comparing `gimera-0.6.80/LICENSE.txt` & `gimera-0.6.9/LICENSE.txt`

 * *Files identical despite different names*

### Comparing `gimera-0.6.80/PKG-INFO` & `gimera-0.6.9/PKG-INFO`
...
### Comparing `gimera-0.6.80/gimera/gitcommands.py` & `gimera-0.6.9/gimera/gitcommands.py`
...
### Comparing `gimera-0.6.80/gimera/repo.py` & `gimera-0.6.9/gimera/repo.py`
...
### Comparing `gimera-0.6.80/gimera.egg-info/PKG-INFO` & `gimera-0.6.9/gimera.egg-info/PKG-INFO`
