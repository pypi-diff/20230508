# Comparing `tmp/NikeCA-0.1.97rc0.tar.gz` & `tmp/NikeCA-0.2.0.tar.gz`
...
## Comparing `NikeCA-0.1.97rc0.tar` & `NikeCA-0.2.0.tar`
...
### Comparing `NikeCA-0.1.97rc0/LICENSE` & `NikeCA-0.2.0/LICENSE`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/PKG-INFO` & `NikeCA-0.2.0/PKG-INFO`
...
### Comparing `NikeCA-0.1.97rc0/README.md` & `NikeCA-0.2.0/README.md`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/setup.py` & `NikeCA-0.2.0/setup.py`
...
### Comparing `NikeCA-0.1.97rc0/src/Dashboards/Dashboards.py` & `NikeCA-0.2.0/src/Dashboards/Dashboards.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/Dashboards/InclusionExclusion/InclusionExclusion.py` & `NikeCA-0.2.0/src/Dashboards/InclusionExclusion/InclusionExclusion.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/Dashboards/Telemetry/ProductUsage.py` & `NikeCA-0.2.0/src/Dashboards/Telemetry/ProductUsage.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/Dashboards/Telemetry/Telemetry.py` & `NikeCA-0.2.0/src/Dashboards/Telemetry/Telemetry.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/NikeCA.egg-info/PKG-INFO` & `NikeCA-0.2.0/src/NikeCA.egg-info/PKG-INFO`
...
### Comparing `NikeCA-0.1.97rc0/src/NikeCA.egg-info/SOURCES.txt` & `NikeCA-0.2.0/src/NikeCA.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/NikeCA.egg-info/requires.txt` & `NikeCA-0.2.0/src/NikeCA.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/NikeQA.py` & `NikeCA-0.2.0/src/NikeQA.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/NikeSF.py` & `NikeCA-0.2.0/src/NikeSF.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_BuildSearchQuery.py` & `NikeCA-0.2.0/src/_BuildSearchQuery.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_GitHub.py` & `NikeCA-0.2.0/src/_GitHub.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_QA.py` & `NikeCA-0.2.0/src/_QA.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_SearchFiles.py` & `NikeCA-0.2.0/src/_SearchFiles.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_SnowflakeData.py` & `NikeCA-0.2.0/src/_SnowflakeData.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_SnowflakeDependencies.py` & `NikeCA-0.2.0/src/_SnowflakeDependencies.py`

 * *Files identical despite different names*

### Comparing `NikeCA-0.1.97rc0/src/_SnowflakePull.py` & `NikeCA-0.2.0/src/_SnowflakePull.py`
