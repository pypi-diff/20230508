# Comparing `tmp/tencentcloud-sdk-python-redis-3.0.885.tar.gz` & `tmp/tencentcloud-sdk-python-redis-3.0.886.tar.gz`
...
## Comparing `tencentcloud-sdk-python-redis-3.0.885.tar` & `tencentcloud-sdk-python-redis-3.0.886.tar`
...
### Comparing `tencentcloud-sdk-python-redis-3.0.885/README.rst` & `tencentcloud-sdk-python-redis-3.0.886/README.rst`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.885/tencentcloud/redis/v20180412/redis_client.py` & `tencentcloud-sdk-python-redis-3.0.886/tencentcloud/redis/v20180412/redis_client.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.885/tencentcloud/redis/v20180412/errorcodes.py` & `tencentcloud-sdk-python-redis-3.0.886/tencentcloud/redis/v20180412/errorcodes.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.885/tencentcloud/redis/v20180412/models.py` & `tencentcloud-sdk-python-redis-3.0.886/tencentcloud/redis/v20180412/models.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.885/tencentcloud/__init__.py` & `tencentcloud-sdk-python-redis-3.0.886/tencentcloud/__init__.py`
...
### Comparing `tencentcloud-sdk-python-redis-3.0.885/PKG-INFO` & `tencentcloud-sdk-python-redis-3.0.886/PKG-INFO`
...
### Comparing `tencentcloud-sdk-python-redis-3.0.885/setup.py` & `tencentcloud-sdk-python-redis-3.0.886/setup.py`

 * *Files identical despite different names*

### Comparing `tencentcloud-sdk-python-redis-3.0.885/tencentcloud_sdk_python_redis.egg-info/PKG-INFO` & `tencentcloud-sdk-python-redis-3.0.886/tencentcloud_sdk_python_redis.egg-info/PKG-INFO`
