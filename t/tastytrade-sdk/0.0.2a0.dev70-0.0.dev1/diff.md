# Comparing `tmp/tastytrade_sdk-0.0.2a0.dev70.tar.gz` & `tmp/tastytrade-sdk-0.0.dev1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "tastytrade_sdk-0.0.2a0.dev70.tar", max compression
+gzip compressed data, was "tastytrade-sdk-0.0.dev1.tar", last modified: Sun May  7 01:57:12 2023, max compression
```

## Comparing `tastytrade_sdk-0.0.2a0.dev70.tar` & `tastytrade-sdk-0.0.dev1.tar`

### file list

```diff
@@ -1,14 +1,14 @@
--rw-r--r--   0        0        0      735 2023-05-08 03:08:22.849319 tastytrade_sdk-0.0.2a0.dev70/README.md
--rw-r--r--   0        0        0      640 2023-05-08 03:08:45.585770 tastytrade_sdk-0.0.2a0.dev70/pyproject.toml
--rw-r--r--   0        0        0       75 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/__init__.py
--rw-r--r--   0        0        0     1309 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/api.py
--rw-r--r--   0        0        0       90 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/instruments/__init__.py
--rw-r--r--   0        0        0     1787 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/instruments/instruments.py
--rw-r--r--   0        0        0      323 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/instruments/models.py
--rw-r--r--   0        0        0      100 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/market_metrics/__init__.py
--rw-r--r--   0        0        0     1155 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/market_metrics/market_metrics.py
--rw-r--r--   0        0        0      272 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/market_metrics/models.py
--rw-r--r--   0        0        0      757 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/tastytrade.py
--rw-r--r--   0        0        0       86 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/watchlists/__init__.py
--rw-r--r--   0        0        0      461 2023-05-08 03:08:22.853319 tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/watchlists/watchlists.py
--rw-r--r--   0        0        0     1420 1970-01-01 00:00:00.000000 tastytrade_sdk-0.0.2a0.dev70/PKG-INFO
...
### Comparing `tastytrade_sdk-0.0.2a0.dev70/src/tastytrade_sdk/api.py` & `tastytrade-sdk-0.0.dev1/tastytrade_sdk/api.py`
