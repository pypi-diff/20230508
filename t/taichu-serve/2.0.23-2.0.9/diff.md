# Comparing `tmp/taichu-serve-2.0.23.tar.gz` & `tmp/taichu-serve-2.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist/taichu-serve-2.0.23.tar", last modified: Mon May  8 06:30:25 2023, max compression
+gzip compressed data, was "taichu-serve-2.0.9.tar", last modified: Wed Apr 19 02:34:49 2023, max compression
```

## Comparing `taichu-serve-2.0.23.tar` & `taichu-serve-2.0.9.tar`

### file list

```diff
@@ -1,37 +1,35 @@
-drwxr-xr-x   0 caiyueliang   (501) staff       (20)        0 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/
--rw-r--r--   0 caiyueliang   (501) staff       (20)      236 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/PKG-INFO
--rw-r--r--   0 caiyueliang   (501) staff       (20)     7397 2023-04-27 09:53:59.000000 taichu-serve-2.0.23/README.md
--rw-r--r--   0 caiyueliang   (501) staff       (20)       38 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/setup.cfg
--rw-r--r--   0 caiyueliang   (501) staff       (20)     1138 2023-05-06 10:00:56.000000 taichu-serve-2.0.23/setup.py
-drwxr-xr-x   0 caiyueliang   (501) staff       (20)        0 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve/
--rw-r--r--   0 caiyueliang   (501) staff       (20)     4130 2023-05-06 08:06:22.000000 taichu-serve-2.0.23/taichu_serve/__init__.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)    12994 2023-05-08 03:46:33.000000 taichu-serve-2.0.23/taichu_serve/app.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     8721 2023-05-08 06:16:05.000000 taichu-serve-2.0.23/taichu_serve/command.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)      889 2023-04-25 06:18:51.000000 taichu-serve-2.0.23/taichu_serve/common.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     6390 2023-04-27 09:53:59.000000 taichu-serve-2.0.23/taichu_serve/dockerfile.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     1521 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/error_code.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     6336 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/grpc_predict_v2_pb2.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)    13010 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/grpc_predict_v2_pb2_grpc.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     6820 2023-05-08 06:24:39.000000 taichu-serve-2.0.23/taichu_serve/grpc_server.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     2316 2023-05-06 02:54:53.000000 taichu-serve-2.0.23/taichu_serve/log.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     5471 2023-05-06 08:06:22.000000 taichu-serve-2.0.23/taichu_serve/model_server.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)      205 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/ratelimiter.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     3351 2023-05-06 08:17:59.000000 taichu-serve-2.0.23/taichu_serve/settings.py
-drwxr-xr-x   0 caiyueliang   (501) staff       (20)        0 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve/template/
--rw-r--r--   0 caiyueliang   (501) staff       (20)        0 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/template/__init__.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)      848 2023-04-24 08:19:39.000000 taichu-serve-2.0.23/taichu_serve/template/model_service.py
-drwxr-xr-x   0 caiyueliang   (501) staff       (20)        0 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve/template/test/
--rw-r--r--   0 caiyueliang   (501) staff       (20)        0 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/template/test/__init__.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)      691 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/template/test/grpc_client.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)      286 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/template/test/http_client.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)      932 2023-04-23 10:26:19.000000 taichu-serve-2.0.23/taichu_serve/template/test/stream_grpc_client.py
-drwxr-xr-x   0 caiyueliang   (501) staff       (20)        0 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve/third/
--rw-r--r--   0 caiyueliang   (501) staff       (20)        0 2023-05-08 01:45:25.000000 taichu-serve-2.0.23/taichu_serve/third/__init__.py
--rw-r--r--   0 caiyueliang   (501) staff       (20)     2676 2023-05-08 06:16:05.000000 taichu-serve-2.0.23/taichu_serve/third/tracer.py
-drwxr-xr-x   0 caiyueliang   (501) staff       (20)        0 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/
--rw-r--r--   0 caiyueliang   (501) staff       (20)      236 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/PKG-INFO
--rw-r--r--   0 caiyueliang   (501) staff       (20)      894 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/SOURCES.txt
--rw-r--r--   0 caiyueliang   (501) staff       (20)        1 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/dependency_links.txt
--rw-r--r--   0 caiyueliang   (501) staff       (20)       58 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/entry_points.txt
--rw-r--r--   0 caiyueliang   (501) staff       (20)      117 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/requires.txt
--rw-r--r--   0 caiyueliang   (501) staff       (20)       13 2023-05-08 06:30:25.000000 taichu-serve-2.0.23/taichu_serve.egg-info/top_level.txt
...
### Comparing `taichu-serve-2.0.23/taichu_serve/__init__.py` & `taichu-serve-2.0.9/taichu_serve/model_server.py`
...
### Comparing `taichu-serve-2.0.23/taichu_serve/common.py` & `taichu-serve-2.0.9/taichu_serve/common.py`
...
### Comparing `taichu-serve-2.0.23/taichu_serve/error_code.py` & `taichu-serve-2.0.9/taichu_serve/error_code.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.23/taichu_serve/grpc_predict_v2_pb2.py` & `taichu-serve-2.0.9/taichu_serve/grpc_predict_v2_pb2.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.23/taichu_serve/grpc_predict_v2_pb2_grpc.py` & `taichu-serve-2.0.9/taichu_serve/grpc_predict_v2_pb2_grpc.py`

 * *Files identical despite different names*

### Comparing `taichu-serve-2.0.23/taichu_serve/log.py` & `taichu-serve-2.0.9/taichu_serve/log.py`
...
### Comparing `taichu-serve-2.0.23/taichu_serve/template/test/grpc_client.py` & `taichu-serve-2.0.9/taichu_serve/template/test/grpc_client.py`
...
### Comparing `taichu-serve-2.0.23/taichu_serve/template/test/stream_grpc_client.py` & `taichu-serve-2.0.9/taichu_serve/template/test/stream_grpc_client.py`
...
### Comparing `taichu-serve-2.0.23/taichu_serve.egg-info/SOURCES.txt` & `taichu-serve-2.0.9/taichu_serve.egg-info/SOURCES.txt`
