# Comparing `tmp/periodic_element_properties-0.1.4.tar.gz` & `tmp/periodic_element_properties-0.1.5.tar.gz`
...
## Comparing `periodic_element_properties-0.1.4.tar` & `periodic_element_properties-0.1.5.tar`
...
### Comparing `periodic_element_properties-0.1.4/periodic_element_properties/properties_of_elements.json` & `periodic_element_properties-0.1.5/periodic_element_properties/properties_of_elements.json`
