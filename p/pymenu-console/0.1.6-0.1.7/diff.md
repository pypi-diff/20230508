# Comparing `tmp/pymenu-console-0.1.6.tar.gz` & `tmp/pymenu-console-0.1.7.tar.gz`
...
+gzip compressed data, was "dist\pymenu-console-0.1.7.tar", last modified: Mon May  8 16:58:38 2023, max compression
```

## Comparing `pymenu-console-0.1.6.tar` & `pymenu-console-0.1.7.tar`
...
+drwxrwxrwx   0        0        0        0 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/
+-rw-rw-rw-   0        0        0     3143 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/PKG-INFO
+-rw-rw-rw-   0        0        0     2092 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/README.md
+drwxrwxrwx   0        0        0        0 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/pymenu/
+-rw-rw-rw-   0        0        0       56 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/pymenu/__init__.py
+-rw-rw-rw-   0        0        0     1818 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/pymenu/auto_menu.py
+-rw-rw-rw-   0        0        0     3282 2023-05-08 16:55:29.000000 pymenu-console-0.1.7/pymenu/menu.py
+-rw-rw-rw-   0        0        0      267 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/pymenu/option.py
+-rw-rw-rw-   0        0        0      546 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/pymenu/select_menu.py
+drwxrwxrwx   0        0        0        0 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/pymenu/utils/
+-rw-rw-rw-   0        0        0        0 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/pymenu/utils/__init__.py
+-rw-rw-rw-   0        0        0      572 2023-05-08 16:50:02.000000 pymenu-console-0.1.7/pymenu/utils/inputs.py
+drwxrwxrwx   0        0        0        0 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/pymenu_console.egg-info/
+-rw-rw-rw-   0        0        0     3143 2023-05-08 16:58:37.000000 pymenu-console-0.1.7/pymenu_console.egg-info/PKG-INFO
+-rw-rw-rw-   0        0        0      348 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/pymenu_console.egg-info/SOURCES.txt
+-rw-rw-rw-   0        0        0        1 2023-05-08 16:58:37.000000 pymenu-console-0.1.7/pymenu_console.egg-info/dependency_links.txt
+-rw-rw-rw-   0        0        0       19 2023-05-08 16:58:37.000000 pymenu-console-0.1.7/pymenu_console.egg-info/requires.txt
+-rw-rw-rw-   0        0        0        7 2023-05-08 16:58:37.000000 pymenu-console-0.1.7/pymenu_console.egg-info/top_level.txt
+-rw-rw-rw-   0        0        0       42 2023-05-08 16:58:38.000000 pymenu-console-0.1.7/setup.cfg
+-rw-rw-rw-   0        0        0      730 2023-05-08 16:58:33.000000 pymenu-console-0.1.7/setup.py
```

### Comparing `pymenu-console-0.1.6/pymenu/auto_menu.py` & `pymenu-console-0.1.7/pymenu/auto_menu.py`

 * *Files identical despite different names*

### Comparing `pymenu-console-0.1.6/pymenu/menu.py` & `pymenu-console-0.1.7/pymenu/menu.py`
...
### Comparing `pymenu-console-0.1.6/pymenu/select_menu.py` & `pymenu-console-0.1.7/pymenu/select_menu.py`

 * *Files identical despite different names*

### Comparing `pymenu-console-0.1.6/pymenu/utils/inputs.py` & `pymenu-console-0.1.7/pymenu/utils/inputs.py`

 * *Files identical despite different names*

### Comparing `pymenu-console-0.1.6/setup.py` & `pymenu-console-0.1.7/setup.py`
